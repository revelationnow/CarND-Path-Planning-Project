      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            P.SetPrevPath(previous_path_x, previous_path_y);
            P.SetCarData(car_x, car_y, car_s, car_d, car_yaw, convert_MPH_to_mps(car_speed));

          	// TODO: define a path made up of (x,y) points that the car will visit sequentially every .02 seconds
            P.PlanPath(next_x_vals, next_y_vals, previous_path_x, previous_path_y, sensor_fusion);
